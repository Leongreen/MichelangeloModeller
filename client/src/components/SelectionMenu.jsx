        ...
        return (
            <div className="w-full text-left border border-gray-400 rounded-md bg-white z-50">
                <Menu as="div" className="relative">
                    ...
                    >
                        <Menu.Items className="z-50 absolute right-0 w-full origin-top-right divide-y divide-gray-100 rounded-b-md bg-gray-100 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                            {this.rows}
                        </Menu.Items>
                    </Transition>
                </Menu>
